...
// //                   handleSubmit(
// //                     () => setProducts([]),
// //                     (id:any) => setProducts((prevProducts) => prevProducts.filter((product) => product.id !== id))
// //                   )
// //                 }
// //                 className="text-sm"
// //               >
...
//               <Button onClick={closeModal} variant="outline" className="text-sm bg-red-300">
//                 {t("Cancel")}
//               </Button>
//               <Button
//                 onClick={() =>
//                   handleSubmit(
//                     () => setProducts([]),
//                     (id) => setProducts((prevProducts) => prevProducts.filter((product) => product.id !== id))
//                   )
//                 }
...
import { Toaster, toast } from 'react-hot-toast'
import ScreenKeyboard from "../../components/ui/ScreenKeyBoard/ScreenKeyBoard"
import MagellanScaleScanner from "../../container/MagellanScanner"
